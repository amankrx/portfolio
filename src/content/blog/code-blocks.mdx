...
description: Syntax highlighting, line numbers, line highlights, word highlights. Syntax highlighting, line numbers, line highlights, word highlights
date: 2024-03-04
...
```rs showLineNumbers title="main.rs" caption="This is a sample caption with line numbers. I have added the rust sample code to see how it works"
struct Point {
  x: f64,
  y: f64,
}
